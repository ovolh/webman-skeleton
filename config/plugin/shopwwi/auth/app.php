...
return [
    'enable' => true,
    'app_key' => env('APP_KEY', 'base64:N721v3Gt2I58HH7oiU7a70PQ+i8ekPWRqwI+JSnM1wo='),
    'guard' => [
        'user' => [
            'key' => 'id',
    ...
    'jwt' => [
        'redis' => true,// 开启redis后，刷新token要等过期时间后才能刷新token，否则报异常
        // 算法类型 ES256、HS256、HS384、HS512、RS256、RS384、RS512
        'algorithms' => 'HS256',
        // access令牌秘钥
        'access_secret_key' => env('JWT_ACCESS_SECRET_KEY', 'vQ3O4Jaijz8gK1Z3r1ZXSCsPYWW1TJq62Vrd299ansT0a0iU5zZoYrtooe6dlXJw'),
        // access令牌过期时间，单位秒。默认 2 小时
        'access_exp' => 36000,
        // refresh令牌秘钥
        'refresh_secret_key' => env('JWT_REFRESH_SECRET_KEY', 'vQ3O4Jaijz8gK1Z3r1ZXSCsPYWW1TJq62Vrd299ansT0a0iU5zZoYrtooe6dlXJw'),
